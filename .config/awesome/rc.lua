...
beautiful.init("/home/austinmatherne/.config/awesome/themes/pango/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create right-hand widgets depending on screen position
    s.rightwidgets = {
      layout = wibox.layout.fixed.horizontal,
    }

    if s.index == 1 then
      table.insert(s.rightwidgets, wibox.widget.systray())
      table.insert(s.rightwidgets, mytextclock)
    elseif s.index == 2 then
      table.insert(s.rightwidgets, volwidget)
      table.insert(s.rightwidgets, cpuwidget)
      table.insert(s.rightwidgets, memwidget)
      table.insert(s.rightwidgets, netwidget)
    end
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Escape", function () awful.util.spawn("xlock -username 'Username: '") end,
              {description = "lock", group = "client"}),
    ...
    awful.key({ modkey,           }, "Print", function () awful.util.spawn("scrot -e 'mv $f ~/Downloads/ 2>/dev/null'") end,
              {description = "screen capture", group = "client"}),
    ...
    awful.key({ modkey, "Control" }, "r",     function () awful.util.spawn("cycle")   end,
              {description = "reboot", group = "system"}),
    awful.key({ modkey, "Control" }, "q",     function () awful.util.spawn("off") end,
              {description = "shutdown", group = "system"}),
    awful.key({ modkey, "Control" }, "s",     function () awful.util.spawn_with_shell("~/bin/xsleep") end,
...
awful.rules.rules = {
    ...
    { rule_any = { class = { "Chromium-browser-chromium",
                             ...
                             "Google-chrome-unstable",
                             "Opera" } },
      except_any = { role = { "pop-up", "GtkFileChooserDialog" }, instance = { "Dialog" } },
