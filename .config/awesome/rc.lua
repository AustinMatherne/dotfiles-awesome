...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "r",     function () awful.util.spawn("sudo reboot")   end),
    awful.key({ modkey, "Control" }, "q",     function () awful.util.spawn("sudo poweroff") end),
...
awful.rules.rules = {
    ...
    { rule_any = { class = { "Chromium-browser", "Google-chrome", "Firefox", "Opera" } },
    ...
    { rule = { class = "Chromium-browser", role = "pop-up", instance = "chromium-browser" },
      properties = { tag = tags[3][1],
                           floating = false } },
    { rule = { class = "Google-chrome", role = "pop-up", instance = "google-chrome" },
      properties = { tag = tags[3][1],
                           floating = false } },
    { rule = { class = "URxvt" },
