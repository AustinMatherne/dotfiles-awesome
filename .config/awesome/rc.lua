...
if beautiful.wallpaper then
    ...
    --end
    gears.wallpaper.tiled(beautiful.wallpaper, nill)
end
-- }}}
...
mytextclock = awful.widget.textclock(" %a %b %d, %l:%M:%S %p ", 1)
...
awful.rules.rules = {
    ...
    { rule_any = { class = { "Chromium-browser", "Google-chrome-stable", "Google-chrome-beta", "Google-chrome-unstable", "Firefox", "Opera" } },
...
if not xresources:match(xresources_name) then
    ...
    awful.util.spawn_with_shell("urxvtd --quiet --opendisplay --fork && urxvtc -e zsh -c 'source ~/.zshrc && vim --servername vim' && urxvtc && urxvtc -e irssi")
